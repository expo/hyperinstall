/* @generated */var AwaitLock, CONFIG_FILE, Hyperinstall, STATE_FILE, _, childProcess, co, crypto, digestStream, fs, fstreamNpm, npmPackageArg, path, rimraf, streamToPromise, util;
...
Hyperinstall = (function() {
      ...
      (yield _.map(packages, (function(_this) {
        return function(cacheBreaker, name) {
          ...
          updatePackageAsync = co.wrap(function*() {
            ...
            return _this.updatePackageAsync(name, cacheBreaker, deps);
          });
  ...
  Hyperinstall.prototype.readFileChecksumAsync = function(filePath, algorithm) {
    return new Promise(function(resolve, reject) {
      return fs.createReadStream(filePath).on('error', reject).pipe(digestStream(algorithm, 'hex', function(digest) {
