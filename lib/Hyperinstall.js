...
class Hyperinstall {
  ...
  updatePackageIfNeededAsync(name, cacheBreaker) {
    ...
    return _asyncToGenerator(function* () {
      ...
      } else if (_this6.packageNeedsUpdate(name, cacheBreaker, targetPackageState)) {
        yield _this6.updatePackageAsync(name, cacheBreaker, targetPackageState);
      }
    })();
  }
  ...
  packageNeedsUpdate(name, cacheBreaker, targetPackageState) {
    ...
    return !(0, _isEqual2.default)(targetUnversionedDepChecksums, installedUnversionedDepChecksums);
  }
